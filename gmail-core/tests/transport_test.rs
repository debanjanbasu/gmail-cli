use gmail_core::client::{apply_transport_version, resolve_transport_mode, TransportMode};
...
async fn base_url_override_builds_without_probing_when_h3_disabled() {
    ...
    let config = GmailConfig {
        performance: PerformanceConfig { enable_http3: false, ..PerformanceConfig::default() },
        ..GmailConfig::default()
    };
