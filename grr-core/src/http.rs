...
// â”€â”€ Auto-tuned transport constants â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
impl HttpCore {
    ...
    /// stored token must not brick construction â€” `grr auth login`
                ...
                Ok(resp) => {
                    ...
                    match status.as_u16() {
                        401 => {
                            ...
                            // credential and can never succeed â€” and clearing
                            ...
                            return Err(GrrError::Auth(
                                "request rejected as unauthorized (401); \
                                 your access token is expired or invalid â€” \
