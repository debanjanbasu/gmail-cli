//! grr-people — People (Google Contacts) API client for the grr suite.
//!
//! Typed endpoints (list connections, prefix search, get, create,
//! update, delete) over grr-core's shared HTTP/3 engine.
//!
//! ```no_run
//! # async fn demo() -> Result<(), Box<dyn std::error::Error>> {
//! use grr_core::auth::AuthConfigBuilder;
//! use grr_people::{ListConnectionsOptions, PeopleClientBuilder};
//!
